...
> This is a sample of a Markdown file used as an example of how the app renders it [(source)](https://github.com/microsoft/AI-For-Beginners/blob/main/README.md)
...
For a gentle introduction to _AI in the Cloud_ topics you may consider taking the [Get started with artificial intelligence on Azure](https://docs.microsoft.com/learn/paths/get-started-with-artificial-intelligence-on-azure/?WT.mc_id=academic-77998-cacaste) Learning Path.
